...
interface WaterUploadModalProps {
  open: boolean;
  onClose: () => void;
  onUpload: () => void;
}

export default function WaterUploadModal({ open, onClose, onUpload }: WaterUploadModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-2xl shadow-xl w-full max-w-lg mx-4 p-8">
        <h2 className="text-xl font-bold text-gray-900 mb-6">Upload Water Consumption Data</h2>
