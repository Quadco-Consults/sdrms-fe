...
export default function Biodiversity() {
  ...
  const downloadTemplate = () => {
    ...
    const csvContent =
      headers.join(",") +
      "\n" +
      "On-site,Flora,Least Concern,Protection,25,Hectares,Jan 2026,NNPC E&P,Main Facility,Sample notes";

    const blob = new Blob([csvContent], { type: "text/csv" });
    const url = window.URL.createObjectURL(blob);
    const a = document.createElement("a");
    a.href = url;
    a.download = "biodiversity_template.csv";
    a.click();
      ...
      {showForm && (
        <div className="bg-white rounded-xl border-l-4 border-green-600 shadow-sm p-6 border border-gray-200">
          ...
          <div className="grid grid-cols-2 gap-6 mb-6">
            ...
            <div>
              <label className="text-xs font-bold text-gray-700 uppercase tracking-wider mb-1.5 block">
                Species Type <span className="text-red-600">*</span>
              </label>
              <select
                value={formData.speciesType}
                onChange={(e) =>
                  setFormData({ ...formData, speciesType: e.target.value })
                }
                className="w-full h-10 px-3 bg-gray-50 border border-gray-300 rounded-lg text-sm text-gray-900 focus:outline-none focus:border-green-600 focus:ring-2 focus:ring-green-100 transition-all"
              >
                <option>Flora</option>
            ...
            <div>
              <label className="text-xs font-bold text-gray-700 uppercase tracking-wider mb-1.5 block">
                Conservation Status (IUCN) <span className="text-red-600">*</span>
              </label>
              <select
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="text-xs font-bold text-gray-700 uppercase tracking-wider mb-1.5 block">
                  Area Size <span className="text-red-600">*</span>
                </label>
                <input
                  type="number"
              ...
              <tr>
                <td colSpan={8} className="py-20 text-center">
                  ...
                  <div className="text-gray-500 text-sm font-bold uppercase tracking-widest">
                    No biodiversity data logged yet.
                  </div>
                </td>
              </tr>
            ) : (
          ...
          <div className="bg-white rounded-lg w-full max-w-2xl">
            <div className="p-6 border-b border-gray-200">
              <h2 className="text-xl font-bold text-gray-900">
                Bulk Upload: Biodiversity
              </h2>
              <p className="text-sm text-gray-600 mt-1">
                Upload CSV or Excel files to log multiple biodiversity records at once.
              </p>
            </div>
            ...
            <div className="p-6">
              ...
              <div className="mb-6">
                ...
                <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                  <div className="grid grid-cols-3 gap-2 text-xs">
                    <div className="font-mono text-gray-600">Impact Area</div>
                    <div className="font-mono text-gray-600">Species Type</div>
                    <div className="font-mono text-gray-600">Conservation Status</div>
                    <div className="font-mono text-gray-600">Action Taken</div>
                    <div className="font-mono text-gray-600">Area Size</div>
              ...
              <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center hover:border-green-500 transition-colors">
                <input
                  type="file"
                  id="bulk-upload-biodiversity"
                  accept=".csv,.xlsx,.xls"
                  onChange={handleFileUpload}
                  className="hidden"
                />
                <label
                  htmlFor="bulk-upload-biodiversity"
