...
export default function WorkforceDiversity() {
  ...
  const downloadTemplate = () => {
    ...
    const csvContent =
      headers.join(",") +
      "\n" +
      "Gender,Female,35,Jan 2026,NNPC E&P,Main Facility,Sample notes";

    const blob = new Blob([csvContent], { type: "text/csv" });
    const url = window.URL.createObjectURL(blob);
    const a = document.createElement("a");
    a.href = url;
    a.download = "workforce_diversity_template.csv";
    a.click();
          ...
          <div className="bg-white rounded-lg w-full max-w-2xl">
            <div className="p-6 border-b border-gray-200">
              <h2 className="text-xl font-bold text-gray-900">
                Bulk Upload: Workforce & Diversity
              </h2>
              <p className="text-sm text-gray-600 mt-1">
                Upload CSV or Excel files to log multiple workforce diversity records at once.
              </p>
            </div>
            ...
            <div className="p-6">
              <div className="mb-6">
                ...
                <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                  <div className="grid grid-cols-3 gap-2 text-xs">
                    ...
                    <div className="font-mono text-gray-600">Sub Category</div>
              ...
              <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center hover:border-green-500 transition-colors">
                <input
                  type="file"
                  id="bulk-upload-workforce"
                  accept=".csv,.xlsx,.xls"
                  onChange={handleFileUpload}
                  className="hidden"
                />
                <label
                  htmlFor="bulk-upload-workforce"
