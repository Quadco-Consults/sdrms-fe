...
export default function HSESafety() {
  ...
  const [records, setRecords] = useState<HSERecord[]>([
    {
      ...
      unit: "Count",
      manHours: "250000",
      description: "No lost time injuries recorded",
      rootCause: "N/A",
  ...
  const downloadTemplate = () => {
    ...
    const csvContent =
      headers.join(",") +
      "\n" +
      "LTI,0,Count,250000,No incidents,N/A,N/A,Jan 2026,NNPC E&P,Main Facility,Sample notes";

    const blob = new Blob([csvContent], { type: "text/csv" });
    const url = window.URL.createObjectURL(blob);
    const a = document.createElement("a");
    a.href = url;
    a.download = "hse_safety_template.csv";
    a.click();
      ...
      {showForm && (
        <div className="bg-white rounded-xl border-l-4 border-green-600 shadow-sm p-6 border border-gray-200">
          ...
          <div className="grid grid-cols-2 gap-6 mb-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full h-10 px-3 bg-gray-50 border border-gray-300 rounded-lg text-sm text-gray-900 focus:outline-none focus:border-green-600 focus:ring-2 focus:ring-green-100 transition-all"
                  placeholder="e.g., Count, Hours, Rate"
                />
              </div>
            </div>
            ...
            <div>
              <label className="text-xs font-bold text-gray-700 uppercase tracking-wider mb-1.5 block">
                Total Man Hours <span className="text-red-600">*</span>
              </label>
              <input
                type="number"
                value={formData.manHours}
                onChange={(e) =>
                  setFormData({ ...formData, manHours: e.target.value })
                }
                className="w-full h-10 px-3 bg-gray-50 border border-gray-300 rounded-lg text-sm text-gray-900 focus:outline-none focus:border-green-600 focus:ring-2 focus:ring-green-100 transition-all"
                placeholder="Total exposure hours"
              />
            </div>
            ...
            <div className="col-span-2">
              ...
              <textarea
                ...
                className="w-full p-3 bg-gray-50 border border-gray-300 rounded-lg text-sm text-gray-900 min-h-[60px] resize-none focus:outline-none focus:border-green-600 focus:ring-2 focus:ring-green-100 transition-all"
                placeholder="Describe the incident or safety metric..."
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full h-10 px-3 bg-gray-50 border border-gray-300 rounded-lg text-sm text-gray-900 focus:outline-none focus:border-green-600 focus:ring-2 focus:ring-green-100 transition-all"
                placeholder="e.g., Equipment Failure, Human Error"
              />
            </div>
              ...
              records.map((record, i) => (
                ...
                >
                  ...
                  <td className="px-4 py-3 text-sm font-bold text-gray-600 tabular-nums">
                    {Number(record.manHours).toLocaleString()} hrs
                  </td>
          ...
          <div className="bg-white rounded-lg w-full max-w-2xl">
            <div className="p-6 border-b border-gray-200">
              <h2 className="text-xl font-bold text-gray-900">
                Bulk Upload: HSE & Safety
              </h2>
              <p className="text-sm text-gray-600 mt-1">
                Upload CSV or Excel files to log multiple HSE safety records at once.
              </p>
            </div>
              ...
              <div className="mb-6">
                ...
                <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                  <div className="grid grid-cols-3 gap-2 text-xs">
                    <div className="font-mono text-gray-600">Incident Type</div>
                    <div className="font-mono text-gray-600">Value</div>
                    <div className="font-mono text-gray-600">Unit</div>
                    <div className="font-mono text-gray-600">Man Hours</div>
                    <div className="font-mono text-gray-600">Description</div>
                    <div className="font-mono text-gray-600">Root Cause</div>
                    <div className="font-mono text-gray-600">Corrective Action</div>
